[←Lean 4.7.0 (2024-04-03)](releases/v4.7.0/#release-v4___7___0 "Lean 4.7.0 \(2024-04-03\)")[Lean 4.5.0 (2024-02-01)→](releases/v4.5.0/#release-v4___5___0 "Lean 4.5.0 \(2024-02-01\)")
#  Lean 4.6.0 (2024-02-29)[🔗](find/?domain=Verso.Genre.Manual.section&name=release-v4___6___0 "Permalink")
...
This helps when writing termination proofs interactively, as one can focus each subgoal individually, for example using `·`. Previously, the given tactic script had to work for _all_ goals, and one had to resort to tactic combinators like `first`:
